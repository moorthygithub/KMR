...
// import Layout from "../src/pages/common/new/MainLayout/index";
...
import Banner from "../src/pages/Master/Banner/Banner";
import AddBanner from "../src/pages/Master/Banner/AddBanner";
import EditBanner from "../src/pages/Master/Banner/EditBanner";
///////////////TRADERS///////////////////////////////
import Live from "../src/pages/Traders/Live/Live";
import EditLive from "../src/pages/Traders/Live/EditLive";
import EditAll from "./pages/Traders/Live/EditLiveAll";

import Rate from "../src/pages/Traders/Rates/Rates";
import EditRate from "../src/pages/Traders/Rates/EditRates";
import EditAllRate from "../src/pages/Traders/Rates/EditAllRate";
      ...
      <StatusProvider>
        <Routes>
          ...
          <Route path="/" element={<Layout />}>
            ...
            <Route path="/traders/live/editall" element={<EditAll />} />

            <Route path="/traders/rates" element={<Rate />} />
            <Route path="/traders/rates/edit" element={<EditRate />} />
            <Route path="/traders/rates/editall" element={<EditAllRate />} />
