        ...
        customBodyRender: (id) => (
          <>
            <Tooltip title="Edit" placement="top">
              <IconButton
                aria-label="Edit"
                onClick={() => navigate(`/traders/rates/edit?id=${id}`)}
              >
                <EditIcon />
              </IconButton>
            </Tooltip>
            ...
            <Tooltip title="Edit All" placement="top">
              <IconButton
                aria-label="Edit All"
                onClick={() => navigate(`/traders/rates/editall?id=${id}`)}
              >
                <BorderColorIcon />
              </IconButton>
            </Tooltip>
  ...
  const getData = async () => {
    ...
    try {
      const response = await axios.get(
        `${baseURL}/panel-fetch-vendor-rates-list`,
        {
          headers: {
  ...
  return (
    ...
    >
      ...
      {loader ? (
        ...
        <>
          <ProfileTitle title="Vendors Rates List" backLink="-1" />
          <MUIDataTable
            title={"Vendors Rates List"}
            data={RateList}
            columns={columnData}
            options={options}
          />
