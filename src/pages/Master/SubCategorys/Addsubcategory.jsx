...
const AddsubCategory = () => {
  ...
  const onSubmit = (e) => {
    ...
    formData.append("category_sub_name", subcategory.subcategory_name);
    formData.append("category_sub_sort", subcategory.category_sub_sort);
          ...
          >
            ...
            <Box flex={1}>
              <TextField
                fullWidth
                required
                label="Category Sub Sort"
                name="category_sub_sort"
                variant="standard"
                value={subcategory.category_sub_sort}
                onChange={onInputChange}
